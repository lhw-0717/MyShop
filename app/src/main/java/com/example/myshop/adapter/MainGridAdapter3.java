...
public class MainGridAdapter3 extends DelegateAdapter.Adapter {
    ...
    private List<HomeBean.DataBean.CategoryListBean.GoodsListBean> list = new ArrayList<>();

    public MainGridAdapter3(GridLayoutHelper gridLayoutHelper) {
    ...
    public void getData(List<HomeBean.DataBean.CategoryListBean.GoodsListBean> goodsList) {
